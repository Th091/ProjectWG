 ...
 * on 2016-09-25 at 17:25:26 UTC 
 * Modify at your own risk.
 */

package com.wgappbackend.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the userendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetUser extends UserendpointRequest<com.wgappbackend.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.wgappbackend.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.wgappbackend.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.wgappbackend.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.wgappbackend.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.wgappbackend.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.wgappbackend.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.wgappbackend.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.wgappbackend.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.wgappbackend.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.wgappbackend.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.wgappbackend.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.wgappbackend.userendpoint.model.User.class);
    }
