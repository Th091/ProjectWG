 ...
 * on 2016-09-24 at 13:16:32 UTC 
 * Modify at your own risk.
 */

package com.wgappbackend.noteendpoint;
...
public class Noteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the noteendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetNote extends NoteendpointRequest<com.wgappbackend.noteendpoint.model.Note> {
    ...
    protected GetNote(java.lang.String id) {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.wgappbackend.noteendpoint.model.Note.class);
   ...
   *
   * @param content the {@link com.wgappbackend.noteendpoint.model.Note}
   * @return the request
   */
  public InsertNote insertNote(com.wgappbackend.noteendpoint.model.Note content) throws java.io.IOException {
    InsertNote result = new InsertNote(content);
    initialize(result);
    return result;
  }

  public class InsertNote extends NoteendpointRequest<com.wgappbackend.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected InsertNote(com.wgappbackend.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "POST", REST_PATH, content, com.wgappbackend.noteendpoint.model.Note.class);
    }
  ...
  public class ListNote extends NoteendpointRequest<com.wgappbackend.noteendpoint.model.CollectionResponseNote> {
     ...
     */
    protected ListNote() {
      super(Noteendpoint.this, "GET", REST_PATH, null, com.wgappbackend.noteendpoint.model.CollectionResponseNote.class);
    }
   ...
   * @return the request
   */
  public UpdateNote updateNote(com.wgappbackend.noteendpoint.model.Note content) throws java.io.IOException {
    UpdateNote result = new UpdateNote(content);
    initialize(result);
    return result;
  }

  public class UpdateNote extends NoteendpointRequest<com.wgappbackend.noteendpoint.model.Note> {
     ...
     * @since 1.13
     */
    protected UpdateNote(com.wgappbackend.noteendpoint.model.Note content) {
      super(Noteendpoint.this, "PUT", REST_PATH, content, com.wgappbackend.noteendpoint.model.Note.class);
    }
