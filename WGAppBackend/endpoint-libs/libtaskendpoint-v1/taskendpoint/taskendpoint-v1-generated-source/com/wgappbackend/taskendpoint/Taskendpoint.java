...
package com.wgappbackend.taskendpoint;
...
public class Taskendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the taskendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetTask extends TaskendpointRequest<com.wgappbackend.taskendpoint.model.Task> {
    ...
    protected GetTask(java.lang.Long id) {
      super(Taskendpoint.this, "GET", REST_PATH, null, com.wgappbackend.taskendpoint.model.Task.class);
   ...
   *
   * @param content the {@link com.wgappbackend.taskendpoint.model.Task}
   * @return the request
   */
  public InsertTask insertTask(com.wgappbackend.taskendpoint.model.Task content) throws java.io.IOException {
    InsertTask result = new InsertTask(content);
    initialize(result);
    return result;
  }

  public class InsertTask extends TaskendpointRequest<com.wgappbackend.taskendpoint.model.Task> {
     ...
     * @since 1.13
     */
    protected InsertTask(com.wgappbackend.taskendpoint.model.Task content) {
      super(Taskendpoint.this, "POST", REST_PATH, content, com.wgappbackend.taskendpoint.model.Task.class);
    }
  ...
  public class ListTask extends TaskendpointRequest<com.wgappbackend.taskendpoint.model.CollectionResponseTask> {
     ...
     */
    protected ListTask() {
      super(Taskendpoint.this, "GET", REST_PATH, null, com.wgappbackend.taskendpoint.model.CollectionResponseTask.class);
    }
   ...
   * @return the request
   */
  public UpdateTask updateTask(com.wgappbackend.taskendpoint.model.Task content) throws java.io.IOException {
    UpdateTask result = new UpdateTask(content);
    initialize(result);
    return result;
  }

  public class UpdateTask extends TaskendpointRequest<com.wgappbackend.taskendpoint.model.Task> {
     ...
     * @since 1.13
     */
    protected UpdateTask(com.wgappbackend.taskendpoint.model.Task content) {
      super(Taskendpoint.this, "PUT", REST_PATH, content, com.wgappbackend.taskendpoint.model.Task.class);
    }
